...
int check(int* arr,int size,int rate_flow,int i){
     ...
     if((i)==size || ((i)==0)){
        if (i==0){
            if(arr[i]>arr[i+1]){
                if (arr[i]%rate_flow)
                //return start.
                if (arr[i]%rate_flow!=0){
                    return arr[i]/rate_flow + 1;
                }
                else {
               ...
               if (arr[i+1]%rate_flow!=0){
                    return arr[i+1]/rate_flow + 1;
                }
                else {
    ...
    if ((i+1)<=size && ((i-1)>=0)){
            ...
            //return start.
           if (arr[m]%rate_flow!=0){
                    return arr[m]/rate_flow + 1;
                }
                else {
                    return ((arr[m]%rate_flow)+(arr[m]/rate_flow));
                }
        }
    else {//return start.
        if (arr[i]%rate_flow!=0){
